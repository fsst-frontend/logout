...
onMounted(() => {
  userInfo.value = partnerStore.currentSubInfo || {}
...
<template>
  <FullPageView :style="{ backgroundColor: '#F7F7F7' }">
    ...
    <div class="mx-3 mt-2 px-5 py-2 rounded-12px bg-white pos-relative">
      <UserCard :user-info="userInfo" :border-line="false" @click="router.push(`/detail/more?uid=${userInfo.uid}`)" />
    </div>
